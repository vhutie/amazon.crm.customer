 ...
 */
package com.amazon.crm.customer;
...
public class CustomerController {
    ...
    @CrossOrigin
    @RequestMapping(method = RequestMethod.GET, value = "/amazon.crm.customer", produces = "text/plain")
    ...
    @CrossOrigin
    @RequestMapping(method = RequestMethod.GET, value = "/amazon.crm.customer-chaining", produces = "application/json")
    @ApiOperation("Returns the greeting plus the next service in the chain")
    public List<String> sayHelloChaining() {
        List<String> greetings = new ArrayList<>();
        greetings.add(ola());
        greetings.addAll(customerService.customer());
        return greetings;
    }

    @CrossOrigin
    @RequestMapping(method = RequestMethod.GET, value = "/amazon.crm.customer-secured", produces = "text/plain")
